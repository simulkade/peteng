...
while t<t_final
    ...
    while error_s>tol_s
        ...
        RHS = [RHS_bc_p+RHS_t_s_wmb+RHS_a_s_wmb+M_a_s_wmb*sw_val.value[:];
  ...
  # title("Sw")
  visualizeCells(cs_init/cs_inj)
  # title("c_DME")
  visualizeCells(cp_init/cp_inj)
  PyPlot.legend(["Sw", "C_salt", "C_polymer"])
  # title("c_tracer")
  # savefig("profile.png")
  # figure(2)
  # plot(t_s, rec_fact)
